...
export const API_TAGS: ReadonlyArray<{ name: string; description: string }> = [
  ...
  { name: 'Search', description: 'Full-text search across org projects, events, and artifacts.' },
...
const TAG_PREFIXES: ReadonlyArray<[RegExp, string]> = [
  ...
  [/^\/v1\/search/, 'Search'],
  [/^\/v1\/quota/, 'Quota'],
  [/^\/v1\/feature-flags/, 'Feature Flags'],
  [/^\/v1\/usage/, 'Usage'],
  [/^\/v1\/sso/, 'SSO'],
  [/^\/v1\/export/, 'Export'],
  [/^\/v1\/leads/, 'Leads'],
